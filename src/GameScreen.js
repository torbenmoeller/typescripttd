...
(function (TypeScriptTD) {
    var GameScreen = (function (_super) {
        ...
        function GameScreen() {
            ...
            //UI
            _this.TowerButtons = Array();
            _this.buildMode = false;
            _this.IsInProgress = false;
            _this.Grid = new TypeScriptTD.Grid(19, 11);
            _this.Towers = Array();
            _this.Enemies = Array();
            _this.Paths = new TypeScriptTD.PathPlanner();
            _this.MapId = 1;
            _this.towerIds = new Array("tower-gun", "tower-laser", "tower-missile", "tower-quake-wave", "tower-rocket");
            _this.weaponIds = new Array("fx-small-round", "fx-laser", "fx-missile", "fx-quake-wave", "fx-rocket");
            _this.creepIds = new Array("flyer-fast", "flyer-slow", "land-basic", "land-fast", "land-slow");
            return _this;
        }
